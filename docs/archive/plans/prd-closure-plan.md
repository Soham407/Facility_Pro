...
> This captures a web-local PRD closure campaign and should not override the current workspace scope in [root `STATUS.md`](../../../STATUS.md) and [root `ROADMAP.md`](../../../ROADMAP.md).

## Summary

Implement and verify the entire current `docs/product/prd.md` scope as mandatory scope, not just the already-audited client subset. The goal is to close three classes of gaps across the promoted `main` state at `758dbb2`:
...
- Build a PRD-to-product matrix from `docs/product/prd.md`, `e2e/feature-matrix.ts`, and `docs/archive/audits/2026-02-prd-audit-report.md`.
...
- Update `docs/archive/audits/2026-02-prd-audit-report.md` after each closure slice with `verified`, `fixed`, `untested`, and `blocked`.
