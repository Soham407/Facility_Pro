...
> Kept for history. The active closure tracker now lives in `docs/planning/prd-gap-register.md`.
...
Most of the original 20-item gap list below is now implemented in the current branch. This document is kept as historical context; the live PRD closure record now lives in `docs/planning/prd-gap-register.md`.

| # | Gap | Type | Status |
|---|-----|------|--------|
| 1 | Hidden nav items (built but invisible) | Config | ✅ Implemented |
| 2 | AccountsDashboard widget | Dashboard | ✅ Implemented |
| 3 | MDDashboard revenue/growth cards | Dashboard | ✅ Implemented |
| 4 | Missing roles: Storekeeper, Site Supervisor | RBAC | ✅ Implemented |
| 5 | Service Delivery Note & Acknowledgment | Workflow | ✅ Implemented |
| 6 | Buyer Feedback Flow | Workflow | ✅ Implemented |
| 7 | Recruitment BGV Status Tracking UI | HRMS | ✅ Implemented |
| 8 | Chemical Expiry Alerts (Pest Control) | Safety | ✅ Implemented |
| 9 | Spill Kit Inventory | Safety | ✅ Implemented |
| 10 | Ad-Space Booking Workflow | Services | ✅ Implemented |
| 11 | Auto-Punch-Out Cron Job | HR Ops | ✅ Implemented |
| 12 | Shortage Notes Auto-Calculation UI | Quality | ✅ Implemented |
| 13 | Personnel Dispatch Tracking (Staffing) | Workflow | ✅ Implemented |
| 14 | Daily Visitor Category Separation | Society | ✅ Implemented |
| 15 | Revenue Analytics Dashboard | Reports | ✅ Implemented |
| 16 | Shift-Based Attendance Cross-Validation | HR Ops | ✅ Implemented |
| 17 | Guard Emergency Contact One-Tap Dial | Guard UX | ✅ Implemented |
| 18 | Society Manager Analytics | Dashboard | ✅ Implemented |
| 19 | Notification Bell UI | Platform | ✅ Implemented |
| 20 | Guard Mobile PWA Wrapper | Mobile | ✅ Implemented |
