...
> Archived demo-cycle blockers from 2026-05-09.
> Replaced by `docs/demo/checklist.md` as the active route guide.
...
### B-3 — Smoke-walk all 6 roles per `docs/archive/demo/2026-05-09-demo-checklist.md`
...
See `docs/archive/demo/2026-05-09-demo-assumptions.md` A-3 through A-10 for items deliberately deferred
