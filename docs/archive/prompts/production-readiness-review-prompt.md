...
> Kept for history. It does not describe the current source-of-truth documentation flow.
...
- `docs/archive/implementation/2026-03-production-readiness-fix-plan.md` — prior analysis (if exists — do not hallucinate, just skip if absent)
